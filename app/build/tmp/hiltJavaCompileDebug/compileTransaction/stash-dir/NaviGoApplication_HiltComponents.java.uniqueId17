...
import com.sensecode.navigo.di.DatabaseModule;
import com.sensecode.navigo.di.FirebaseModule;
import com.sensecode.navigo.di.NetworkModule;
import com.sensecode.navigo.di.RepositoryModule;
import com.sensecode.navigo.di.SensorModule;
...
public final class NaviGoApplication_HiltComponents {
  private NaviGoApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements NaviGoApplication_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          MapShareViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          MapShareViewModel_HiltModules.BindsModule.class,
